import svgPaths from "./svg-4xc4xrx5ol";
...
function PopulerPlan() {
  return (
    <div className="relative rounded-[8px] shrink-0 w-full" data-name="Populer Plan">
...
export default function Filters() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-start p-[4px] relative size-full" data-name="Filters">
      <PopulerPlan />
      <PopulerPlan1 />
      <PopulerPlan2 />
      <PopulerPlan3 />
