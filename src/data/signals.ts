...
/**
 * @param companies        The accounts the four charts — Activity Level, Buyers
 *                         Tech Stack, Headquarter Location and Company Size —
 *                         are broken down from. The caller has narrowed these
 *                         by every active filter.
